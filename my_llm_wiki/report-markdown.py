# generate WIKI_REPORT.md — human-readable audit trail for the knowledge wiki
...
_is_file_node = _analyze._is_file_node
_is_concept_node = _analyze._is_concept_node
...
def generate(
    ...
    """Generate a markdown audit report for the knowledge wiki build.

    Returns the full report as a string — caller writes it to disk.
    """
    ...
    lines = [
        f"# Knowledge Wiki Report - {root}  ({today})",
        "",
        "## Corpus Check",
    ]
    ...
    for cid, nodes in communities.items():
        ...
        # Filter file stubs from display — they're structural noise
