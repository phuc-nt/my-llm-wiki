# export graph as Wikipedia-style markdown articles: index.md + one per community + god node pages
...
def _community_article(
    ...
    lines += ["---", "", "*Part of the knowledge wiki. See [[index]] to navigate.*"]
    return "\n".join(lines)
...
def _index_md(
    ...
    lines: list[str] = [
        ...
        "",
        "> Auto-generated knowledge wiki. Start here — read community articles for context, then drill into god nodes for detail.",
        "",
    ...
    lines += ["---", "", "*Auto-generated knowledge wiki*"]
    return "\n".join(lines)
