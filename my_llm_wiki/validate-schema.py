# validate extraction JSON against the wiki schema before graph assembly
from __future__ import annotations

from my_llm_wiki.constants import VALID_FILE_TYPES, VALID_CONFIDENCES
...
def validate_extraction(data: dict) -> list[str]:
    """Validate an extraction dict against the wiki schema.
